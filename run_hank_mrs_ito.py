...
from ks_hank_hw.residuals import HANKMRSItoResidual
...
def main():
    ...
    output_dir = Path(__file__).resolve().parent / "mrs_ito_outputs"
    ...
    residual = HANKMRSItoResidual(cfg.model)
    ...
    start_progress_monitor(monitor_path, progress_path, cfg.train.train_epochs, "hank-ito")
    ...
    with (output_dir / "mrs_ito_summary.json").open("w", encoding="utf-8") as f:
    ...
    print("Summary:", output_dir / "mrs_ito_summary.json")
